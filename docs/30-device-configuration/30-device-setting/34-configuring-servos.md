...
Если вы разобрали устройство и требуется восстановить подключение сервоприводов, ориентируйтесь по следующей таблице:
...
:::warning
Перед подключением убедитесь, что Робоголова отключена от питания, а провода и разъёмы не повреждены.
:::
