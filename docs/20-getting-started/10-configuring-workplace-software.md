...
title: "Настройка ПО для рабочего места"
sidebar_label: "Настройка ПО для рабочего места"
sidebar_position: 1
description: "Настройка ПО для рабочего места"
---

---

## <span style={{color: 'red'}}>TODO: Добавить подключение через браузер к code-server</span>
# Настройка ПО для рабочего места
...
1. **Установите Termius или PuTTY**  
   Необходимо для подключения к Робоголове по SSH. Также можно использовать встроенную в Windows командную строку. Для этого откройте командную строку, введите `cmd` и нажмите Enter:
...
Если вы хотите «окунуться» в мир Linux и ROS, но нет возможности установить Ubuntu как отдельную операционную систему, лучший вариант — установить программу для виртуализации VirtualBox:
...
1. **Установите и настройте VirtualBox**  
   ...
   - Скачайте программу VirtualBox: [VirtualBox Downloads](https://www.virtualbox.org/wiki/Downloads)  
