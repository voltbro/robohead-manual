...
> **Важно:** перед запуском распознавания убедитесь, что запущен пакет `respeaker_driver`, который публикует аудиоданные с микрофона, иначе распознавать будет нечего.
