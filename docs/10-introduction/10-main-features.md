...
| "Ответь на вопрос" | Записывает ваш вопрос и отправляет его большой языковой модели, чтобы получить ответ. Затем ответ озвучивается. Важно: требует дополнительной настройки! | <div style={{display: 'flex', gap: '10px', justifyContent: 'center'}}> <img src={require('./attachments/microphone.gif').default} width="33%" /> <img src={require('./attachments/loading.gif').default} width="33%" /> <img src={require('./attachments/speaker.gif').default} width="33%" /> </div> |
